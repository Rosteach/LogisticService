...
<head>
	...
	<!-- CSS -->
    <link rel="stylesheet" type="text/css" href="resources/css/xls.css"/>
    <link rel="stylesheet" type="text/css" href="resources/css/xlsStructure.css"/>
	<!-- JS -->
    ...
    <div id="header">    
        <div class="infoBar">
            ...
            <div class="infoBarRight">
            	<img src="resources/images/excel-256.png" width=70px height=70px;/>
             </div>
        </div>
    </div>
    <div id="content">
        ...
        <div id="accordion">
              ...
              <div>
                  <div class="leftSide">
                       <form id="form" action="excelveres" method="get">
                       ...
                       <button class="excel" type="submit" form="form">Сгенерировать документ</button>
                  </div>
              </div>
              <h3>Отчет-сверка по выгрузке(ящ)</h3>
              <div>
               	  <div class="leftSide">
                       <form id="sverka" action="excelbox" method="get">
                            <label for="startDate">Начало периода:</label>
                                <input id="startDate" type="date" name="startDate" placeholder="date" required="required"/>
                            <label for="endDate">Конец периода:</label>
                                <input id="endDate" type="date" name="endDate" placeholder="date" required="required"/>
                       </form>
                       <button class="excel" type="submit" form="sverka">Сгенерировать документ</button>
                  </div>
              </div>
              <h3>Section 3</h3>
              <div>
